...
export const drugDatabase: Drug[] = [
  ...
  },
  {
    ...
    category: 'Vitamin',
    therapeuticClass: 'Water-soluble vitamin',
    pharmacologicalClass: 'Pyridoxine',
    mechanism: 'Coenzyme in amino acid metabolism, neurotransmitter synthesis',
    indications: ['B6 deficiency', 'Isoniazid-induced neuropathy', 'Morning sickness'],
    contraindications: ['Hypersensitivity'],
    warnings: ['Peripheral neuropathy with doses >200mg/day chronically'],
    dosage: {
      adult: '1.3-1.7mg daily maintenance, 50-100mg for deficiency',
      pediatric: '0.5-1.3mg daily based on age',
      elderly: 'Standard adult dosing'
    },
    pharmacokinetics: {
      absorption: 'Readily absorbed from GI tract',
      distribution: 'Widely distributed',
      metabolism: 'Hepatic conversion to active pyridoxal phosphate',
      elimination: 'Renal excretion',
      halfLife: '25-33 days',
      bioavailability: '75%'
    },
    drugInteractions: ['Reduces levodopa effectiveness', 'Phenytoin levels may be reduced'],
    monitoring: ['Neurological symptoms', 'B6 levels if available'],
    pregnancyCategory: 'Category A - Safe in pregnancy',
    lactation: 'Compatible',
    overdose: 'Peripheral neuropathy with chronic high doses',
    storage: 'Store at room temperature, protect from light',
    availableStrengths: ['25mg', '50mg', '100mg', '250mg']
  },
  {
    name: 'Gabapentin',
    genericName: 'Gabapentin',
    brands: ['Neurontin', 'Gralise', 'Horizant'],
    composition: [{ activeIngredient: 'Gabapentin', strength: '300mg' }],
    sideEffects: ['Drowsiness', 'Dizziness', 'Fatigue', 'Peripheral edema', 'Weight gain'],
    dosageForms: ['Capsule', 'Tablet', 'Oral solution'],
    disorders: ['Epilepsy', 'Neuropathic pain', 'Restless leg syndrome'],
    incompatibility: ['Antacids', 'Morphine'],
    isPremium: true,
    category: 'Anticonvulsant',
    therapeuticClass: 'GABA analog anticonvulsant',
    pharmacologicalClass: 'Gabapentinoid',
    mechanism: 'Binds to voltage-gated calcium channels, modulates neurotransmitter release',
    indications: ['Partial seizures', 'Postherpetic neuralgia', 'Diabetic neuropathy', 'RLS'],
    contraindications: ['Hypersensitivity to gabapentin'],
    warnings: ['Suicidal thoughts', 'Withdrawal seizures', 'Respiratory depression with opioids'],
    dosage: {
      adult: '300mg TID initially, titrate to 900-3600mg daily',
      pediatric: '10-15mg/kg/day in 3 divided doses',
      elderly: 'Reduce dose based on renal function'
    },
    pharmacokinetics: {
      absorption: 'Dose-dependent absorption via LAT1 transporter',
      distribution: 'Not protein bound, CSF levels 20% of plasma',
      metabolism: 'Not metabolized',
      elimination: 'Renal excretion unchanged',
      halfLife: '5-7 hours',
      bioavailability: '60% at 300mg, decreases with higher doses'
    },
    drugInteractions: ['Antacids reduce absorption', 'Morphine increases gabapentin levels'],
    monitoring: ['Seizure control', 'Renal function', 'Mood changes', 'Suicidal ideation'],
    pregnancyCategory: 'Category C - Use only if benefits outweigh risks',
    lactation: 'Excreted in breast milk, use caution',
    overdose: 'CNS depression, supportive care, hemodialysis effective',
    storage: 'Store at room temperature',
    availableStrengths: ['100mg', '300mg', '400mg', '600mg', '800mg']
  },
  {
    name: 'Nortriptyline',
    genericName: 'Nortriptyline Hydrochloride',
    brands: ['Pamelor', 'Aventyl', 'Norpress'],
    composition: [{ activeIngredient: 'Nortriptyline HCl', strength: '25mg' }],
    sideEffects: ['Dry mouth', 'Constipation', 'Blurred vision', 'Drowsiness', 'Weight gain'],
    dosageForms: ['Capsule', 'Oral solution'],
    disorders: ['Depression', 'Neuropathic pain', 'Migraine prophylaxis'],
    incompatibility: ['MAO inhibitors', 'Linezolid', 'Methylene blue'],
    isPremium: true,
    category: 'Antidepressant',
    therapeuticClass: 'Tricyclic antidepressant',
    pharmacologicalClass: 'Dibenzocycloheptene derivative',
    mechanism: 'Blocks reuptake of norepinephrine and serotonin',
    indications: ['Major depression', 'Neuropathic pain', 'Migraine prevention'],
    contraindications: ['Recent MI', 'MAO inhibitor use within 14 days', 'Narrow-angle glaucoma'],
    warnings: ['Suicidal thoughts in young adults', 'Cardiac conduction effects', 'Anticholinergic effects'],
    dosage: {
      adult: '25mg TID or 75mg at bedtime, max 150mg/day',
      pediatric: 'Not recommended <12 years',
      elderly: '30-50mg daily initially'
    },
    pharmacokinetics: {
      absorption: 'Well absorbed orally',
      distribution: '90-95% protein bound, large volume of distribution',
      metabolism: 'Extensive hepatic metabolism via CYP2D6',
      elimination: 'Renal excretion of metabolites',
      halfLife: '16-90 hours',
      bioavailability: '50% due to first-pass metabolism'
    },
    drugInteractions: ['MAO inhibitors (serotonin syndrome)', 'CYP2D6 inhibitors', 'Anticholinergics'],
    monitoring: ['Mood/suicidal ideation', 'ECG', 'Anticholinergic effects', 'Drug levels'],
    pregnancyCategory: 'Category D - Use only if benefits outweigh risks',
    lactation: 'Excreted in breast milk, use caution',
    overdose: 'Cardiac toxicity, CNS effects, supportive care, sodium bicarbonate for QRS widening',
    storage: 'Store at room temperature, protect from light',
    availableStrengths: ['10mg', '25mg', '50mg', '75mg']
  },
  {
    name: 'Baclofen',
    genericName: 'Baclofen',
    brands: ['Lioresal', 'Kemstro'],
    composition: [{ activeIngredient: 'Baclofen', strength: '10mg' }],
    sideEffects: ['Drowsiness', 'Weakness', 'Dizziness', 'Nausea', 'Confusion'],
    dosageForms: ['Tablet', 'Intrathecal injection'],
    disorders: ['Spasticity', 'Multiple sclerosis', 'Spinal cord injury'],
    incompatibility: ['CNS depressants', 'Alcohol'],
    isPremium: true,
    category: 'Muscle relaxant',
    therapeuticClass: 'GABA-B receptor agonist',
    pharmacologicalClass: 'Centrally acting muscle relaxant',
    mechanism: 'Agonist at GABA-B receptors in spinal cord, reduces muscle spasticity',
    indications: ['Spasticity due to MS or spinal cord lesions', 'Trigeminal neuralgia'],
    contraindications: ['Hypersensitivity'],
    warnings: ['Withdrawal syndrome', 'CNS depression', 'Seizure risk with abrupt discontinuation'],
    dosage: {
      adult: '5mg TID initially, titrate by 5mg TID every 3 days, max 80mg/day',
      pediatric: '>2 years: 10-15mg/day initially, max 40mg/day',
      elderly: 'Start with lower doses'
    },
    pharmacokinetics: {
      absorption: 'Rapidly absorbed, food delays but doesn\'t reduce absorption',
      distribution: '30% protein bound, crosses blood-brain barrier',
      metabolism: 'Minimal hepatic metabolism',
      elimination: 'Renal excretion, 70-80% unchanged',
      halfLife: '2.5-4 hours',
      bioavailability: '70-85%'
    },
    drugInteractions: ['CNS depressants (additive sedation)', 'Antihypertensives'],
    monitoring: ['Spasticity improvement', 'CNS effects', 'Renal function'],
    pregnancyCategory: 'Category C - Use only if benefits outweigh risks',
    lactation: 'Excreted in breast milk in small amounts',
    overdose: 'CNS depression, supportive care, physostigmine for severe cases',
    storage: 'Store at room temperature',
  ...
  },
  {
    ...
    brands: ['Proloprim', 'Trimpex'],
    composition: [{ activeIngredient: 'Trimethoprim', strength: '100mg' }],
    sideEffects: ['Nausea', 'Vomiting', 'Skin rash', 'Hyperkalemia', 'Folate deficiency'],
    dosageForms: ['Tablet', 'Oral solution'],
    disorders: ['UTI', 'Pneumocystis pneumonia prophylaxis'],
    incompatibility: ['Warfarin', 'Phenytoin', 'Digoxin'],
    isPremium: false,
    category: 'Antibiotic',
    therapeuticClass: 'Folate antagonist antibiotic',
    pharmacologicalClass: 'Dihydrofolate reductase inhibitor',
    mechanism: 'Inhibits bacterial dihydrofolate reductase, blocks folate synthesis',
    indications: ['Uncomplicated UTI', 'PCP prophylaxis in combination'],
    contraindications: ['Megaloblastic anemia due to folate deficiency', 'Severe renal impairment'],
    warnings: ['Hyperkalemia', 'Blood dyscrasias', 'Folate deficiency'],
    dosage: {
      adult: '100mg BID or 200mg once daily for UTI',
      pediatric: '4mg/kg BID',
      elderly: 'Reduce dose in renal impairment'
    },
    pharmacokinetics: {
      absorption: 'Rapidly and completely absorbed',
      distribution: 'Widely distributed, 42-46% protein bound',
      metabolism: 'Hepatic metabolism to inactive metabolites',
      elimination: 'Renal excretion, 50-60% unchanged',
      halfLife: '8-10 hours',
      bioavailability: '90-100%'
    },
    drugInteractions: ['Warfarin (enhance anticoagulation)', 'Phenytoin (increase levels)'],
    monitoring: ['CBC', 'Renal function', 'Serum potassium', 'Folate levels'],
    pregnancyCategory: 'Category C - Use with caution',
    lactation: 'Excreted in breast milk, use caution',
    overdose: 'Bone marrow suppression, supportive care, leucovorin rescue',
    storage: 'Store at room temperature, protect from light',
    availableStrengths: ['100mg', '200mg']
  },
  {
    name: 'Sulfamethoxazole',
    genericName: 'Sulfamethoxazole',
    brands: ['Used in combination with Trimethoprim as Bactrim, Septra'],
    composition: [{ activeIngredient: 'Sulfamethoxazole', strength: '400mg' }],
    sideEffects: ['Nausea', 'Skin rash', 'Stevens-Johnson syndrome', 'Blood dyscrasias'],
    dosageForms: ['Tablet (in combination)', 'Suspension (in combination)', 'Injection'],
    disorders: ['UTI', 'Pneumocystis pneumonia', 'Toxoplasmosis'],
    incompatibility: ['Warfarin', 'Phenytoin', 'Methotrexate'],
    isPremium: true,
    category: 'Antibiotic',
    therapeuticClass: 'Sulfonamide antibiotic',
    pharmacologicalClass: 'Para-aminobenzoic acid antagonist',
    mechanism: 'Inhibits bacterial folate synthesis by competing with PABA',
    indications: ['Used in combination with trimethoprim for various infections'],
    contraindications: ['Sulfonamide hypersensitivity', 'Severe renal/hepatic impairment'],
    warnings: ['Stevens-Johnson syndrome', 'Blood dyscrasias', 'Crystalluria'],
    dosage: {
      adult: 'Always used in combination with trimethoprim (5:1 ratio)',
      pediatric: 'Combination dosing based on trimethoprim component',
      elderly: 'Reduce dose in renal impairment'
    },
    pharmacokinetics: {
      absorption: 'Rapidly absorbed orally',
      distribution: '70% protein bound, widely distributed',
      metabolism: 'Hepatic acetylation and glucuronidation',
      elimination: 'Renal excretion',
      halfLife: '10-12 hours',
      bioavailability: '85-90%'
    },
    drugInteractions: ['Warfarin (enhance anticoagulation)', 'Methotrexate (toxicity)'],
    monitoring: ['CBC', 'Renal function', 'Liver function', 'Skin reactions'],
    pregnancyCategory: 'Category C - Avoid near term',
    lactation: 'Excreted in breast milk, avoid in nursing mothers of infants <2 months',
    overdose: 'Crystalluria, acidosis, supportive care, alkalinize urine',
    storage: 'Store at room temperature, protect from light',
    availableStrengths: ['400mg (in combination)', '800mg (in combination)']
  },
  {
    name: 'Albendazole',
    genericName: 'Albendazole',
    brands: ['Albenza', 'Zentel', 'Bendex'],
    composition: [{ activeIngredient: 'Albendazole', strength: '400mg' }],
    sideEffects: ['Headache', 'Dizziness', 'Nausea', 'Abdominal pain', 'Elevated liver enzymes'],
    dosageForms: ['Tablet', 'Chewable tablet', 'Suspension'],
    disorders: ['Hydatid disease', 'Neurocysticercosis', 'Roundworm infections'],
    incompatibility: ['Dexamethasone', 'Praziquantel', 'Cimetidine'],
    isPremium: true,
    category: 'Antiparasitic',
    therapeuticClass: 'Broad-spectrum anthelmintic',
    pharmacologicalClass: 'Benzimidazole carbamate',
    mechanism: 'Inhibits tubulin polymerization, disrupts parasite cellular structure',
    indications: ['Echinococcosis', 'Neurocysticercosis', 'Ascariasis', 'Hookworm'],
    contraindications: ['Pregnancy', 'Hypersensitivity to benzimidazoles'],
    warnings: ['Hepatotoxicity', 'Bone marrow suppression', 'Teratogenicity'],
    dosage: {
      adult: '400mg BID with meals for 1-6 months depending on condition',
      pediatric: '15mg/kg/day in 2 divided doses, max 800mg/day',
      elderly: 'Standard adult dosing with monitoring'
    },
    pharmacokinetics: {
      absorption: 'Poor oral absorption, improved with fatty meals',
      distribution: 'Widely distributed, crosses blood-brain barrier',
      metabolism: 'Hepatic metabolism to active albendazole sulfoxide',
      elimination: 'Biliary excretion primarily',
      halfLife: '8-12 hours for active metabolite',
      bioavailability: '<5% (parent drug), higher for metabolite'
    },
    drugInteractions: ['Dexamethasone increases levels', 'May increase phenytoin levels'],
    monitoring: ['Liver function tests', 'CBC', 'Treatment response imaging'],
    pregnancyCategory: 'Category C - Contraindicated in pregnancy',
    lactation: 'Unknown excretion, use caution',
    overdose: 'Supportive care, monitor liver function',
    storage: 'Store at room temperature',
  ...
  },
  {
    ...
    brands: ['Stromectol', 'Mectizan', 'Ivecop'],
    composition: [{ activeIngredient: 'Ivermectin', strength: '12mg' }],
    sideEffects: ['Nausea', 'Diarrhea', 'Dizziness', 'Pruritus', 'Fever'],
    dosageForms: ['Tablet', 'Topical cream'],
    disorders: ['Strongyloidiasis', 'Onchocerciasis', 'Scabies', 'Head lice'],
    incompatibility: ['Warfarin', 'CYP3A4 inhibitors'],
    isPremium: true,
    category: 'Antiparasitic',
    therapeuticClass: 'Avermectin antiparasitic',
    pharmacologicalClass: 'Macrocyclic lactone',
    mechanism: 'Binds to glutamate-gated chloride channels, causes paralysis of parasites',
    indications: ['Strongyloidiasis', 'Onchocerciasis', 'Scabies', 'River blindness'],
    contraindications: ['Hypersensitivity', 'Pregnancy'],
    warnings: ['CNS effects', 'Mazzotti reaction in onchocerciasis', 'Drug interactions'],
    dosage: {
      adult: '200mcg/kg as single dose, may repeat in 2 weeks for some conditions',
      pediatric: '>15kg: same as adult dosing',
      elderly: 'Standard adult dosing'
    },
    pharmacokinetics: {
      absorption: 'Well absorbed orally, food increases absorption',
      distribution: '93% protein bound, does not cross blood-brain barrier well',
      metabolism: 'Hepatic metabolism via CYP3A4',
      elimination: 'Fecal excretion primarily',
      halfLife: '18 hours',
      bioavailability: 'Enhanced by high-fat meals'
    },
    drugInteractions: ['Warfarin (may increase INR)', 'CYP3A4 inhibitors'],
    monitoring: ['Parasitological cure', 'Mazzotti reaction signs', 'Liver function'],
    pregnancyCategory: 'Category C - Avoid in pregnancy',
    lactation: 'Excreted in breast milk, avoid use',
    overdose: 'CNS depression, supportive care',
    storage: 'Store at room temperature',
    availableStrengths: ['3mg', '6mg', '12mg']
  },
  {
    name: 'Estradiol',
    genericName: 'Estradiol',
    brands: ['Estrace', 'Climara', 'Vivelle', 'Progynova'],
    composition: [{ activeIngredient: 'Estradiol', strength: '2mg' }],
    sideEffects: ['Breast tenderness', 'Nausea', 'Headache', 'Mood changes', 'Thromboembolism'],
    dosageForms: ['Tablet', 'Patch', 'Gel', 'Injection', 'Vaginal tablet'],
    disorders: ['Menopause symptoms', 'Osteoporosis prevention', 'Hypogonadism'],
    incompatibility: ['Smoking', 'CYP3A4 inducers'],
    isPremium: true,
    category: 'Hormone',
